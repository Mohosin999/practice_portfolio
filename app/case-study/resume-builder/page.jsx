  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="w-full lg:w-[60%] space-y-8 pt-6 lg:pt-10 px-3 md:px-6 lg:px-0">
        ...
        =====================================================================*/}
        <section className="space-y-2">
          <h2 className="text-lg lg:text-xl font-semibold flex items-start gap-2">
            {techStack.title}
          </h2>
        ...
        <section className="space-y-4">
          ...
          {challengesAndSolutions.parts.map((part, index) => (
            ...
            >
              ...
              {/* Solution */}
              <p className="text-sm lg:text-base text-gray-800 dark:text-gray-300 pt-2">
        ...
        <section className="space-y-2">
          ...
          {testCodeJourney.lists.map((list, index) => (
            <ul
              key={index}
              className="text-sm lg:text-base pl-3 lg:pl-5 space-y-1 text-gray-800 dark:text-gray-300"
            >
              <li>{list}</li>
            </ul>
          ))}
