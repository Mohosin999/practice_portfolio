  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="w-full lg:w-[87%] h-fit pt-14 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 px-3 md:px-6 lg:px-0">
         ...
         *                      Left Section
         ======================================================== */}
        <div className="w-full lg:w-7/12 min-h-[120px] bg-[#32961C] px-14 py-4 rounded-3xl border border-gray-600/[0.5] shadow-md flex flex-col lg:flex-row items-center gap-2 lg:gap-6">
          {/* Counter 1 */}
         ...
         *                      Right Section
         ======================================================== */}
        <div className="w-full lg:w-5/12 lg:min-h-[120px] bg-[#32961C] px-14 py-4 rounded-3xl border border-gray-600/[0.5] shadow-md flex items-center justify-center">
