...
//   overview,
//   techStack,
// } from "@/app/case-study/live-cricket/live-cricket";

// const CaseStudyLiveCricket = () => {
//   return (
//     <div className="w-full h-full flex flex-col items-center justify-center">
//       <div className="w-full lg:w-[60%] space-y-12 pt-6 lg:pt-10 px-3 md:px-6 lg:px-0">
//         {/* Title */}
//         <h1 className="text-2xl lg:text-3xl font-bold">
//           Live Cricket - Enjoy Real Time Cricket Updates
//         </h1>
...
// export default CaseStudyLiveCricket;
  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center">
        <div className="w-full lg:w-[87%] px-1 md:px-4 lg:px-0">
          <IoIosArrowRoundBack
            size={28}
