    ...
    <>
      ...
      <div className="w-full flex items-center justify-center transition-transform duration-300">
        <div className="w-full lg:w-[87%] flex items-center justify-between px-3 md:px-6 lg:px-0 py-6">
          {/* Left side logo */}
          <Link href={"/"}>
            <h4 className="text-xl lg:text-2xl font-bold active:scale-105 flex items-center hover:text-[#B73ACA] duration-300">
              <HiCode size={40} className="mr-2 text-[#B73ACA]" /> Mohosin
            </h4>
          </Link>
          ...
          <ul className="hidden lg:flex flex-1 justify-end flex-row items-center gap-8">
            ...
            {navlinks.map((link, index) => (
              <li
                ...
                className={`text-sm lg:text-base font-semibold ${
                  pathname === link.path
                    ? "text-[#B73ACA]"
                    : "text-gray-800 dark:text-gray-200 hover:dark:text-[#B73ACA]"
                } hover:text-[#B73ACA] transition-all ease-out duration-200 active:scale-105`}
              >
            ...
            <li>
              <Link href="/contact">
                <button className="text-sm lg:text-base bg-[#B73ACA] font-semibold text-white px-6 py-2 rounded-2xl hover:opacity-85 transition-all ease-out duration-200 whitespace-nowrap active:scale-105">
                  Hire Me
                </button>
              </Link>
            </li>
