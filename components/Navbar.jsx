    ...
    >
      {navlinks.map((link, index) => (
        <li
          ...
          } hover:text-primarycolor transition-all ease-out duration-200 active:scale-105`}
        >
      ...
      <li>
        <Link href="/contact" onClick={onClickLink}>
          <button className="text-sm bg-primarycolor px-6 py-2 rounded-2xl hover:opacity-85 transition-all ease-out duration-200 whitespace-nowrap active:scale-105">
            Hire Me
          </button>
        </Link>
      </li>
